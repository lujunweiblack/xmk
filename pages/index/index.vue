<template>
	...
	<uni-nav-bar  status-bar="true" backgroundColor=" #F8F8F8;">
		<view style="padding-right: 30rpx;color: #a46e37;font-size: 40rpx;font-weight:bold;align-items: center;justify-content: center;display: flex;">
			<image src="../../static/index/logo-5.png" style="width: 50rpx;height: 50rpx;"></image>小模卡</view>
	</uni-nav-bar>
	<view>
